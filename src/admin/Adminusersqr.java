...
public class Adminusersqr extends JFrame {
	...
	Admindiarysqr dairysquare = null;
	
	public Adminusersqr(final Socket socket ,ArrayList<Diary_Segment> result) {
		result_list = result;
		...
		jcatalog.addListSelectionListener(new ListSelectionListener() {
			...
			public void valueChanged(ListSelectionEvent e) {
				...
				if (dairysquare != null && dairysquare.isShowing())
		    		dairysquare.dispose();
		    	dairysquare = new Admindiarysqr(socket,result_list.get(indices[0]));
